...
<body>
        ...
        ?>
    <div>
        <h2 class="centered-header">Patient Status</h2>
    </div>

    <!-- Search Form -->

    <form class="SearchForm" method="GET" action="">
            <input id="SearchBar" type="text" name="search" placeholder="Search PatientsStatus..." value="<?=htmlspecialchars($_GET['search'] ?? '') ?>">
    ...
    <div>
      <?php
        ...
        echo "<table>";
        echo "<tr> <th>Patient ID</th> <th>First Name</th> <th>Last Name</th> <th>Gender</th> <th>Status</th><th>Actions</th></tr>";
        ...
        foreach ($patients as $row) {
           ...
           echo "<tr> 
                  ...
                  <td>$Status</td>
                  <td> 
                   <a href='updatePatientStatusPage.php ?PatientID=$PatientID'> Update </a> &nbsp;&nbsp;
                </tr>";
        }
        echo "</table>";
