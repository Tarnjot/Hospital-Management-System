...
<head>
    ...
    <title>View Upcoming Appointment Patient POV</title>
...
<body>
        ...
        ?>
    <div>
        <h2 class="centered-header">List Of Your Upcoming Appointment</h2>
    </div>
    ...
    <div>
      <?php
        ...
        if (!$hasAppointments) {
            echo "<p class='centered-header'>No Further Upcoming Appointments Found.</p>";
        }
